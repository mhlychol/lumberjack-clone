...
export const useSepetStore = defineStore(
  ...
  actions: {
    ...
    async urunEkle({ urunKodu,urunAciklamasi, renk, beden, adet, fiyat, indirimOrani }: { urunKodu: string; urunAciklamasi:string, renk: string; beden: string;  fiyat: number, adet: number;
      indirimOrani: number;}) {
